...
class LocationUpdateActivity : AppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onResume() {
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(
            ...
            IntentFilter(
                LocationUpdatePeriodicallyService.ACTION_FOREGROUND_ONLY_LOCATION_BROADCAST)
        )
    }

    private fun subcribeLocationUpdate() {
    ...
    private fun requestForegroundPermissions() {
        ...
        if (provideRationale) {
            Snackbar.make(
                findViewById(R.id.activity_location_update),
    ...
    private inner class ForegroundOnlyBroadcastReceiver : BroadcastReceiver() {
        ...
        override fun onReceive(context: Context, intent: Intent) {
            val location = intent.getParcelableExtra<Location>(
                LocationUpdatePeriodicallyService.EXTRA_LOCATION
            )
        }
    }
